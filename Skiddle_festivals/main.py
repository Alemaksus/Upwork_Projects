"""
Collecting of festival contacts 2022 from dynamic site: www.skiddles.com
"""
...
# collect all festivals URLs
fests_urls_list = []

for i in range(0, 141, 24):
    url = f"https://www.skiddle.com/festivals/search/?ajaxing=1&sort=0&fest_name=&from_date=24%20Jan%202022&to_date=\
    &where%5B%5D=2&where%5B%5D=3&where%5B%5D=4&maxprice=500&o={i}&bannertitle=May"
