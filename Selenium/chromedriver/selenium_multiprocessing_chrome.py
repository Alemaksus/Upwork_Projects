...
#             executable_path=r"C:\Coding\Data Science\Data Extraction\Upwork_Projects\Upwork_Projects\Selenium
...
def get_data(url):
    try:
        driver = webdriver.Chrome(
            executable_path=r"C:\Coding\Data Science\Data Extraction\Upwork_Projects\Upwork_Projects\Selenium\chromedriver\chromedriver.exe",
            options=options
        )
        # "C:\\users\\selenium_python\\chromedriver\\chromedriver.exe"
        # r"C:\users\selenium_python\chromedriver\chromedriver.exe"
